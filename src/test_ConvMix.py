...
from data_format import padding_seq_to_same_length, topiocqa_normal
import os
from os import path
...
def get_test_query_embedding(args):
    ...
    test_dataset = topiocqa_normal(args, tokenizer)
...
def get_args():
    ...
    parser.add_argument("--original_file", type=str, default="datasets/topiocqa/topiocqa_test.json")
    parser.add_argument("--passage_embeddings_dir_path", type=str, default="index/topiocqa/ance")
    ...
    parser.add_argument("--trec_gold_qrel_file_path", type=str, default="datasets/topiocqa/topiocqa_test_qrel.tsv")
    ...
    parser.add_argument("--passage_block_num", type=int, default=6)
