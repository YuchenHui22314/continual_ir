...
figures/bucket_qwen_beir_eval.json (produced by
eval_bucket_ance_beir_per_ckpt.py):

  bucket_qwen_bkt_msmarco_forgetting.png  MSMARCO NDCG@10 vs step, 13 train buckets
  bucket_qwen_bkt_beir_forgetting.png     BEIR-13 avg NDCG@10 vs step, 13 buckets
  bucket_qwen_bkt_beir_transfer_delta.png 13 train-bucket x 13 BEIR-dataset
...
EVAL_JSON = f"{FIG_DIR}/bucket_qwen_beir_eval.json"
...
forgetting_curve(lambda m: m["msmarco"], "MSMARCO NDCG@10",
                 f"{FIG_DIR}/bucket_qwen_bkt_msmarco_forgetting.png", ZS["msmarco"])
forgetting_curve(beir_avg, "BEIR-13 avg NDCG@10",
                 f"{FIG_DIR}/bucket_qwen_bkt_beir_forgetting.png", beir_avg(ZS))
...
fig.tight_layout(); fig.savefig(f"{FIG_DIR}/bucket_qwen_bkt_beir_transfer_delta.png",
                                bbox_inches="tight"); plt.close(fig)
print(f"saved {FIG_DIR}/bucket_qwen_bkt_beir_transfer_delta.png")
print("Done.")
